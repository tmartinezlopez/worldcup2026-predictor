...
sample_path="data/raw/sample/historical_results_sample.csv"
...
run_dir=$(python -m src.ingestion.importers.historical_results_importer --input "$sample_path" | tail -n 1)
