...
def test_required_files_exist():
    expected_files = [
        ...
        "data/raw/sample/team_ratings_sample.csv",
        "data/raw/sample/worldcup2026_fixtures_minimal_sample.csv",
        ...
        "scripts/export_batch_report.sh",
        "scripts/final_smoke.sh",
        "scripts/final_smoke_with_simulation.sh",
        "scripts/show_final_artifacts.sh",
        "scripts/build_static_dashboard.sh",
        "scripts/final_demo.sh",
        "scripts/final_release_check.sh",
        "scripts/audit_real_historical_results.sh",
        "scripts/promote_latest_historical_results.sh",
        "scripts/real_data_smoke.sh",
        "scripts/real_data_activation_report.sh",
        "scripts/activate_real_historical_data.sh",
        "scripts/rebuild_with_current_data.sh",
        "scripts/real_data_demo.sh",
        "scripts/run_simulation.sh",
        "scripts/import_team_ratings.sh",
        "scripts/promote_team_ratings.sh",
        "scripts/seed_sample_team_ratings.sh",
        ...
        "src/reporting/export_batch_report.py",
        "src/dashboard/static_dashboard.py",
        "src/data_quality/real_data_activation_report.py",
        "src/orchestration/smoke_summary.py",
        ...
        "src/ingestion/importers/team_ratings_importer.py",
        "src/ingestion/importers/worldcup_fixtures_importer.py",
        ...
        "src/ingestion/promoters/team_ratings_promoter.py",
        "src/ingestion/promoters/worldcup_fixtures_promoter.py",
        "src/ingestion/promoters/worldcup_batch_assigner.py",
        ...
        "tests/test_team_ratings_importer.py",
        "tests/test_worldcup_fixtures_importer.py",
        ...
        "tests/test_team_ratings_promoter.py",
        "tests/test_worldcup_fixtures_promoter.py",
        ...
        "tests/test_feature_store_with_ratings.py",
        "tests/test_team_ratings_scripts_contract.py",
        "tests/test_worldcup_batch_assigner.py",
        "tests/test_worldcup_fixture_scripts_contract.py",
    ]
